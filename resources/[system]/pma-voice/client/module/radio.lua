...
local radioOBJ = nil
RegisterCommand('+radiotalk543', function()
	if GetConvarInt('voice_enableRadios', 1) ~= 1 then return end
	if isDead() then return end
	--if exports['vrp']:isHandcuffed() then return end
...
if gameVersion == 'fivem' then
	RegisterKeyMapping('+radiotalk543', 'Talk over Radio', 'keyboard', GetConvar('voice_defaultRadio', 'LMENU'))
end
