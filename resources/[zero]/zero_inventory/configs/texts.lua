config.texts = {
    ...
    notify_no_nearest_player = 'Nâo há sobreviventes por perto!',
    notify_player_no_weight = 'O sobrevivente não possui espaço na mochila!',
    ...
    notify_nearest_player = "Você não pode acessar o baú/armazém com outros sobreviventes por perto!",
    chestTitle = 'Baú',
