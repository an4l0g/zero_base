lojaderoupa = {
    ...
    { name = "Loja de Roupas",
        locs = {
            -- Loja de Roupa 01
            {x = 70.87, y = -1399.49, z = 29.39, provador = {x = 70.87, y = -1399.49, z = 29.39, heading = 359.29}},
            ...
            -- LOJA DE ROUPA 02
            { x = 430.1, y = -799.67, z = 29.52, provador = {x = 430.1, y = -799.67, z = 29.52, heading = 177.1}},
            ...
            -- LOJA DE ROUPA 03
            { x = 128.63, y = -220.14, z = 54.56, provador = {x = 128.63, y = -220.14, z = 54.56, heading = 115.46}},
            ...
            -- LOJA DE ROUPA 04
            { x = -165.9, y = -310.94, z = 39.74, provador = {x = -165.9, y = -310.94, z = 39.74, heading = 248.85}},
            ...
            -- LOJA DE ROUPA 05
            { x = -830.4, y = -1072.88, z = 11.33, provador = {x = -830.4, y = -1072.88, z = 11.33, heading = 292.33}},
            ...
            -- LOJA DE ROUPA 06
            { x = -714.24, y = -145.74, z = 37.42, provador = {x = -714.24, y = -145.74, z = 37.42, heading = 141.83}},
            ...
            -- LOJA DE ROUPA 07
            { x = -1198.0, y = -769.28, z = 17.32, provador = {x = -1198.0, y = -769.28, z = 17.32, heading = 222.52}}, 
            ...
            -- LOJA DE ROUPA 08 
            { x = -1448.24, y = -235.21, z = 49.82, provador = {x = -1448.24, y = -235.21, z = 49.82, heading = 95.97}},
            ...
            -- LOJA DE ROUPA 09
            { x = -3167.29, y = 1047.19, z = 20.87, provador = {x = -3167.29, y = 1047.19, z = 20.87, heading = 84.66}},
            ...
            -- LOJA DE ROUPA 10
            { x = -1109.44, y = 2709.55, z = 19.11, provador = {x = -1109.44, y = 2709.55, z = 19.11, heading = 311.52}},
            ...
            -- LOJA DE ROUPA 11
            { x = 612.87, y = 2758.49, z = 42.09, provador = {x = 612.87, y = 2758.49, z = 42.09, heading = 292.48}},
            ...
            -- LOJA DE ROUPA 12
            { x = 1190.08, y = 2714.76, z = 38.23, provador = {x = 1190.08, y = 2714.76, z = 38.23, heading = 267.87}},
            ...
            -- LOJA DE ROUPA 13
            { x = 1697.49, y = 4829.94, z = 42.07, provador = {x = 1697.49, y = 4829.94, z = 42.07, heading = 179.54}},
            ...
            -- LOJA DE ROUPA 14
            { x = 12.7, y = 6513.6, z = 31.878, provador = {x = 12.7, y = 6513.6, z = 31.878, heading = 134.57}},    
            ...
            -- LOJA DE ROUPA 15 (Praça) 
            { x = 199.17, y = -879.31, z = 30.72, provador = { x = 199.17, y = -879.31, z = 30.72, heading = 69.75}},    
            { x = 198.5, y = -881.43, z = 30.72, provador = { x = 198.5, y = -881.43, z = 30.72, heading = 69.75}},    
            { x = 199.97, y = -877.01, z = 30.72, provador = { x = 199.97, y = -877.01, z = 30.72, heading = 69.75}},   

            -- POLICIA
            { x = 461.07, y = -999.07, z = 30.69, provador = { x = 461.07, y = -999.07, z = 30.69, heading = 260.72}},   
            { x = 461.02, y = -996.65, z = 30.69, provador = { x = 461.02, y = -996.65, z = 30.69, heading = 265.96}},  

            -- JUIZ
            { x = 248.78, y = -1095.91, z = 36.16, provador = { x = 248.78, y = -1095.91, z = 36.16, heading = 275.14}},   
            { x = 237.76, y = -1099.25, z = 36.16, provador = { x = 237.76, y = -1099.25, z = 36.16, heading = 2.80}},  
           
            -- FAVELA
            { x = 1424.21, y = -38.33, z = 136.14, provador = { x = 1424.21, y = -38.33, z = 136.14, heading = 199.95}},   

            -- KENPACHI
            { x = -788.12, y = 338.58, z = 243.38, provador = { x = -788.12, y = 338.58, z = 243.38, heading = 92.50}},
        },
        perm = "",
        ...
        clouth = {
            ...
            ['p6'] = {price = 500, clouth ={}}, -- relogio
            ['p7'] = {price = 500, clouth ={}}, -- bracelete
        }    
    },
