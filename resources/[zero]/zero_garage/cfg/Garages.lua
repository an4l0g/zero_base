...
------------------------------------------------------------------------------------------------------------------------
    ...
    ['velar'] = { name = 'velar', maker = 'Land Rover', price = 1000000, trunk = 100, glove = 15, type = 'vip', class = 'suvs', banned = false },
    ...
    ['rmodrs6'] = { name = 'RS6 G2', maker = 'Audi', price = 1000000, trunk = 100, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['r1200'] = { name = 'R1250', maker = 'BMW', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ...
    ['hornet'] = { name = 'Hornet', maker = 'Honda', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['a80'] = { name = 'Supra', maker = 'Toyota', price = 1000000, trunk = 30, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['sennagtr'] = { name = 'Senna', maker = 'Mclaren', price = 1000000, trunk = 20, glove = 15, type = 'vip', class = 'super', banned = false },
    ['urus'] = { name = 'Urus', maker = 'Lamborghini', price = 1000000, trunk = 100, glove = 15, type = 'vip', class = 'suvs', banned = false },
    ['ferrariitalia'] = { name = 'Italia 478', maker = 'Ferrari', price = 1000000, trunk = 20, glove = 15, type = 'vip', class = 'super', banned = false },
    ['maxima22'] = { name = 'Nissan maxima', maker = 'Nissan', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['bmwe39'] = { name = 'Bmw e39', maker = 'Bmw', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'super', banned = false },
    ['370zrubytiger'] = { name = '370z', maker = 'Nissan', price = 1000000, trunk = 30, glove = 15, type = 'vip', class = 'super', banned = false },
    ['jeslbwk'] = { name = 'Jesko', maker = 'Koenigsegg', price = 1000000, trunk = 20, glove = 15, type = 'vip', class = 'sports', banned = false },
    ...
    ['rmodr8c'] = { name = 'R8 Conv.', maker = 'Audi', price = 1000000, trunk = 20, glove = 15, type = 'vip', class = 'super', banned = false },
    ['tiger'] = { name = 'Tiger', maker = 'Triumph', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['21Charscat'] = { name = 'Mustang', maker = 'Ford Mustang', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['lancerevolutionx'] = { name = 'Lancer E. X', maker = 'Mitsubishi', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['lancerevolution9'] = { name = 'Lancer E. 9', maker = 'Mitsubishi', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ...
    ['rmodskyline34'] = { name = 'SkyLineR34 G2', maker = 'Nissan', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['nissanskyliner34'] = { name = 'Skyline R34', maker = 'Nissan', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['370zRubyTiger'] = { name = 'Nissan 370z', maker = 'Nissan', price = 1000000, trunk = 30, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['auditt'] = { name = 'Audi TT', maker = 'Audi', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'super', banned = false },
    ['911r'] = { name = '911R', maker = 'Porsche', price = 1000000, trunk = 20, glove = 15, type = 'vip', class = 'super', banned = false },
    ['bmws'] = { name = 'S1000rr', maker = 'Bmw', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['mt09black'] = { name = 'Mt09', maker = 'Yamaha', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ...
    ['q820'] = { name = 'Audi Q8', maker = 'Audi', price = 1000000, trunk = 70, glove = 15, type = 'vip', class = 'suvs', banned = false },
    ...
    ['cbb'] = { name = 'Cb1000R', maker = 'Honda', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['nis15'] = { name = 'Silvia 15', maker = 'Nissan', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['teslaprior'] = { name = 'Prior', maker = 'Tesla', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ['babyjesko'] = { name = 'Baby Jesko', maker = 'Koenigsegg', price = 1000000, trunk = 0, glove = 0, type = 'vip', class = 'super', banned = false },
    ['ram1500'] = { name = 'Ram', maker = 'Dodge Ram', price = 1000000, trunk = 200, glove = 15, type = 'vip', class = 'suvs', banned = false },
    ['rmodgtr50'] = { name = 'GTR 50', maker = 'Nissan', price = 1000000, trunk = 40, glove = 15, type = 'vip', class = 'super', banned = false },
    ['z1000'] = { name = 'Z1000', maker = 'Kawasaki', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['xj6'] = { name = 'XJ-6', maker = 'Yamaha', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['africat'] = { name = 'CRF 1000 Africa', maker = 'Honda', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['tenere1200'] = { name = 'Tenere 12000', maker = 'Yamaha', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'motocycle', banned = false },
    ['fk8'] = { name = 'FK8', maker = 'Honda', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ...
    ['merc23'] = { name = 'Mercedes E-class', maker = 'Mercedes-Benz', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ...
    ['rmodbolide'] = { name = 'Bolide W16', maker = 'Bugatti', price = 1000000, trunk = 20, glove = 15, type = 'vip', class = 'super', banned = false },
    ['amarok'] = { name = 'Amarok', maker = 'Volkswagen', price = 1000000, trunk = 200, glove = 15, type = 'vip', class = 'offroad', banned = false },
    ['rmodgt63mini'] = { name = 'Baby Mercedes', maker = 'Mercedes-Benz', price = 1000000, trunk = 0, glove = 0, type = 'vip', class = 'super', banned = false },
    ['19raptor'] = { name = 'Raptor', maker = 'Ford', price = 1000000, trunk = 200, glove = 15, type = 'vip', class = 'offroad', banned = false },
    ['golfrebaixado'] = { name = 'Golf Rebaixado', maker = 'Volkswagen', price = 65000, trunk = 50, glove = 15, type = 'vip', class = 'sports', banned = false },
    ...
    ['nissanr33tbk'] = { name = 'skyline r33', maker = 'Nissan', price = 1000000, trunk = 50, glove = 15, type = 'vip', class = 'super', banned = false },
    ['718b'] = { name = '718B', maker = 'Porsche', price = 1000000, trunk = 20, glove = 15, type = 'vip', class = 'super', banned = false },
    ['tiger1200'] = { name = 'Tiger 1200', maker = 'Tiger', price = 1000000, trunk = 20, glove = 0, type = 'vip', class = 'super', banned = false },
...
------------------------------------------------------------------------------------------------------------------------
    ...
    ['404_r1200'] = { name = 'Bmw R1200', maker = 'BMW', price = 1000, trunk = 0, glove = 0, type = 'work', class = 'emergency', banned = true },
