...
config.agency = vector3(-552.356, -193.9121, 38.21021)
...
config.list = {
    { work = 'Costureira', url = 'https://i.imgur.com/mJ5hejb.png' },
    { work = 'Entregador', url = 'https://i.imgur.com/cuDz4pk.png' },
    { work = 'Carteiro', url = 'https://i.imgur.com/wDVSghK.png' },
    { work = 'YellowJack', url = 'https://i.imgur.com/JzObkPi.png' },
    { work = 'Gas', url = 'https://i.imgur.com/jszJHBW.png' },
    { work = 'Pedreiro', url = 'https://i.imgur.com/wx6ZEXR.jpeg' },
    { work = 'Eletricista', url = 'https://i.imgur.com/KnalYKy.png' },
    { work = 'Gari', url = 'https://i.imgur.com/KxrfgM4.png' }
}