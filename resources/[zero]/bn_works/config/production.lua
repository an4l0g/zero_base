config.production = {
    ...
    ['encomenda_entregador'] = {
        ['blipText'] = 'PEGAR ENCOMENDA', ['progressBarText'] = 'Pegando a encomenda...',
        ['receiveItems'] = {
    ...
    ['caixa_bebidas'] = {
        ['blipText'] = 'PEGAR CAIXA DE BEBIDAS', ['progressBarText'] = 'Pegando a caixa...',
        ['receiveItems'] = {
