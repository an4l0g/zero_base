...
zero.addBlip = function(x, y, z, idtype, idcolor, text, scale, route)
...
zero.removeBlip = function(id)
	RemoveBlip(id)
end

zero.setGPS = function(x, y)
